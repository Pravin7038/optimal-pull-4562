            ...
            <Container width="90%" margin="auto" fontFamily="font-family: Roboto,Arial,sans-serif" color="#020202" marginTop="3%">
                ...
                <Flex margin="15px" marginLeft="13%" justifyContent="space-between" width="80%" >
                    ...
                    <Box textAlign="left">
                        ...
                        <Link >
                            <Image
                                src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/QR_code_for_mobile_English_Wikipedia.svg/220px-QR_code_for_mobile_English_Wikipedia.svg.png" width="70%" >
                ...
                <Flex justifyContent="center">
                    <Box width="15%" margin="25px"><Link><Heading fontSize="25px" >Stay Connected</Heading></Link></Box>
                    <Flex justifyContent="space-between" width="15%" margin="20px">
                        <Link ><GrFacebook size="40px" /></Link>
